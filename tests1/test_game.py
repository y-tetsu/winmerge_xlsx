...
class TestGame(unittest.TestCase):
    ...
    def test_game(self):
        ...
        with captured_stdout() as stdout:
            ...
            self.assertEqual(game1.ret.winlose, Game.BLACK_WIN)
            self.assertEqual(game1.ret.black_name, 'TopLeft')
            self.assertEqual(game1.ret.white_name, 'BottomRight')
            self.assertEqual(game1.ret.black_num, 10)
            self.assertEqual(game1.ret.white_num, 6)
        ...
        with captured_stdout() as stdout:
            ...
            self.assertEqual(lines, output_ret)
            self.assertEqual(game2.ret.winlose, Game.WHITE_WIN)
            self.assertEqual(game2.ret.black_name, 'TopLeft')
            self.assertEqual(game2.ret.white_name, 'TopLeft')
            self.assertEqual(game2.ret.black_num, 6)
            self.assertEqual(game2.ret.white_num, 10)
        ...
        with captured_stdout() as stdout:
            ...
            self.assertEqual(lines, output_ret)
            self.assertEqual(game3.ret.winlose, Game.DRAW)
            self.assertEqual(game3.ret.black_name, 'TopLeft')
            self.assertEqual(game3.ret.white_name, 'BottomRight')
            self.assertEqual(game3.ret.black_num, 2)
            self.assertEqual(game3.ret.white_num, 2)
        ...
        with captured_stdout() as stdout:
            ...
            self.assertEqual(lines, output_ret)
            self.assertEqual(game4.ret.winlose, Game.WHITE_WIN)
            self.assertEqual(game4.ret.black_name, 'Foul')
            self.assertEqual(game4.ret.white_name, 'BottomRight')
            self.assertEqual(game4.ret.black_num, 3)
            self.assertEqual(game4.ret.white_num, 1)
        ...
        with captured_stdout() as stdout:
            ...
            self.assertEqual(lines, output_ret)
            self.assertEqual(game5.ret.winlose, Game.BLACK_WIN)
            self.assertEqual(game5.ret.black_name, 'TopLeft')
            self.assertEqual(game5.ret.white_name, 'Foul')
            self.assertEqual(game5.ret.black_num, 4)
            self.assertEqual(game5.ret.white_num, 1)
    ...
    def test_game_players_teardown(self):
        ...
        expected_result = game.ret

        self.assertEqual(p1.strategy.info, expected_board)
        self.assertEqual(p1.strategy.ret, expected_result)
        self.assertEqual(p2.strategy.info, expected_board)
        self.assertEqual(p2.strategy.ret, expected_result)
