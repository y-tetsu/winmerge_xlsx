...
class TestNegaScout(unittest.TestCase):
    ...
    def test_negascout_get_score(self):
        for class_name in NEGASCOUT_CLASSES:
            ...
            self.assertEqual(negascout.__get_score('black', board, negascout._MIN, negascout._MAX, 1), -3)
            self.assertEqual(negascout.__get_score('black', board, negascout._MIN, negascout._MAX, 2), -1)
            self.assertEqual(negascout.__get_score('black', board, negascout._MIN, negascout._MAX, 3), -4)
            self.assertEqual(negascout.__get_score('black', board, negascout._MIN, negascout._MAX, 4), 0)

            board.put_disc('black', 3, 2)
            self.assertEqual(negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 1), 1)
            self.assertEqual(negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 2), 4)
            self.assertEqual(negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 3), 0)
            self.assertEqual(negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 4), 3)
    ...
    def test_negascout_performance_of_get_score(self):
        ...
        score = negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 5, pid=pid)  # depth 5
        ...
        Measure.count[pid] = 0
        score = negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 2, pid=pid)  # depth 2
        self.assertEqual(score, -10.75)
        self.assertEqual(Measure.count[pid], 20)

        Measure.count[pid] = 0
        score = negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 3, pid=pid)  # depth 3
        self.assertEqual(score, 6.25)
        self.assertEqual(Measure.count[pid], 76)

        Measure.count[pid] = 0
        score = negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 4, pid=pid)  # depth 4
        ...
        Measure.count[pid] = 0
        score = negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 6, pid=pid)  # depth 6
        self.assertEqual(score, -3.5)
        self.assertEqual(Measure.count[pid], 1275)

        Measure.count[pid] = 0
        score = negascout.__get_score('white', board, negascout._MIN, negascout._MAX, 7, pid=pid)  # depth 7
